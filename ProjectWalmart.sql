...
-- ADD NEW COLUMN WITH THE HELP OF ALTER COMMAND
...
--  1) how many unique cities are present in data

SELECT distinct city FROM SALES;
-- select city from SALES;
-- select count(city) from SALES where city="Yangon";
...
-- 6) What is the most common product line by gender
SELECT
	gender,
    product_line,
...
-- 10) How many unique product lines does the data have?
SELECT
...
-- 12) What is the most selling product line
SELECT
	SUM(quantity) as qty,
    product_line
FROM sales
...
-- 13) What is the total revenue by month
SELECT
	month_name AS month,
	SUM(total) AS total_revenue
FROM sales
